            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <strong>Registro de equipo <small>Todos los campos (<b style="color: red;">*</b>) son requeridos.</small></strong>
                    </div>
                    <div class="card-body card-block">
                        <form action="{{ route('equipos.store') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="nombre" class=" form-control-label"><b style="color: red;">*</b></label> Nombre</label></div>
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="lema" class=" form-control-label"><b style="color: red;">*</b></label> Lema</label></div>
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="liga" class=" form-control-label"><b style="color: red;">*</b></label> Liga</label></div>
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="logo" class=" form-control-label"><b style="color: red;">*</b></label> Logo</label></div>
