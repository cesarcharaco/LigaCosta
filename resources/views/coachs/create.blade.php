            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <strong>Registro de coach</strong>
                    </div>
                    <div class="card-body card-block">
                        <form action="{{ route('coachs.store') }}" method="post" class="form-horizontal">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="number" id="edad" name="edad" placeholder="Ingrese la edad..." min="18" max="80" required="required" class="form-control"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="equipo" class=" form-control-label">Equipos</label></div>
